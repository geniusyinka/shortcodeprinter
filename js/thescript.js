...
jQuery(document).ready(function($){  
    ...
    {  
        $.ajax({  
            url: "/WORD/wp-content/plugins/shortcodeTool/admin/myselect.php",  
            method:"POST",  
    ...
    $(document).on('click', '#submit', function(){  
        ...
        if(shortcode == '')  
        {  
            alert("Enter ShortCode");  
            return false;  
        }   
        $.ajax({ 
            // headers: {'X-CSRF-TOKEN': nonce}, 
            url:"/WORD/wp-content/plugins/shortcodeTool/admin/insert.php",  
            method:"POST",  
    ...
    {  
        $.ajax({  
            url:"/WORD/wp-content/plugins/shortcodeTool/admin/editCode.php",  
            method:"POST",  
